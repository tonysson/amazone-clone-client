...
import { validatePasswordLenght } from '../../../shared/utils/validation/length';
            ...
            <Box sx={{ border: 1, padding: 2, borderColor: '#cccccc', width: '350px', marginTop: 2 }}>
                <form onSubmit={onSubmitHandler}>
                    <Grid container direction='column' justifyContent='flex-start'>
                        ...
                        <Button disabled={!validatePasswordLenght(password) || !validateEmail(email)} variant='contained' style={{
                            marginTop: '16px',
                            height: '31px',
