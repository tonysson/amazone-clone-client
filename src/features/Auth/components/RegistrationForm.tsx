...
import { Box, Grid, TextField, InputLabel, Button, Divider, Typography, CircularProgress } from '@mui/material'
import { FC, FormEvent, useEffect, useCallback } from 'react'
import { Link, useNavigate } from 'react-router-dom';
import { validateNameLenght, validatePasswordLenght } from '../../../shared/utils/validation/length';
...
const RegistrationForm: FC = () =>
{
    ...
    } = useInput(validatePasswordLenght);
    ...
    const clearForm = useCallback(() =>
    {
        ...
        [confirmPasswordClearHandler, emailClearHandler, nameClearHandler, passwordClearHandler],
    )
